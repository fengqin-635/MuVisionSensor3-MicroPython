...
QDEF(MP_QSTR_GestureDown, (const byte*)"\x90\x0b" "GestureDown")
QDEF(MP_QSTR_GestureLeft, (const byte*)"\xf9\x0b" "GestureLeft")
QDEF(MP_QSTR_GestureNone, (const byte*)"\x28\x0b" "GestureNone")
QDEF(MP_QSTR_GesturePull, (const byte*)"\x27\x0b" "GesturePull")
QDEF(MP_QSTR_GesturePush, (const byte*)"\x1c\x0b" "GesturePush")
QDEF(MP_QSTR_GestureRight, (const byte*)"\x62\x0c" "GestureRight")
QDEF(MP_QSTR_GestureUp, (const byte*)"\x07\x09" "GestureUp")
...
QDEF(MP_QSTR_LS_AMBIENT_LIGHT_ENABLE, (const byte*)"\xa2\x17" "LS_AMBIENT_LIGHT_ENABLE")
QDEF(MP_QSTR_LS_COLOR_ENABLE, (const byte*)"\x26\x0f" "LS_COLOR_ENABLE")
QDEF(MP_QSTR_LS_GESTURE_ENABLE, (const byte*)"\x5c\x11" "LS_GESTURE_ENABLE")
QDEF(MP_QSTR_LS_PROXIMITY_ENABLE, (const byte*)"\xce\x13" "LS_PROXIMITY_ENABLE")
QDEF(MP_QSTR_Label, (const byte*)"\x63\x05" "Label")
QDEF(MP_QSTR_LedAll, (const byte*)"\x49\x06" "LedAll")
QDEF(MP_QSTR_LedSetColor, (const byte*)"\xf7\x0b" "LedSetColor")
QDEF(MP_QSTR_LedSetMode, (const byte*)"\x29\x0a" "LedSetMode")
...
QDEF(MP_QSTR_LsBegin, (const byte*)"\x3d\x07" "LsBegin")
QDEF(MP_QSTR_LsColorBlue, (const byte*)"\xf9\x0b" "LsColorBlue")
QDEF(MP_QSTR_LsColorGreen, (const byte*)"\xfc\x0c" "LsColorGreen")
QDEF(MP_QSTR_LsColorHue, (const byte*)"\x3f\x0a" "LsColorHue")
QDEF(MP_QSTR_LsColorLabel, (const byte*)"\x01\x0c" "LsColorLabel")
QDEF(MP_QSTR_LsColorRed, (const byte*)"\x34\x0a" "LsColorRed")
QDEF(MP_QSTR_LsColorSaturation, (const byte*)"\xdb\x11" "LsColorSaturation")
QDEF(MP_QSTR_LsColorValue, (const byte*)"\x0c\x0c" "LsColorValue")
QDEF(MP_QSTR_LsEnd, (const byte*)"\xb5\x05" "LsEnd")
QDEF(MP_QSTR_LsRawColorBlue, (const byte*)"\x9d\x0e" "LsRawColorBlue")
QDEF(MP_QSTR_LsRawColorGreen, (const byte*)"\xd8\x0f" "LsRawColorGreen")
QDEF(MP_QSTR_LsRawColorRed, (const byte*)"\x10\x0d" "LsRawColorRed")
QDEF(MP_QSTR_LsReadAmbientLight, (const byte*)"\x4e\x12" "LsReadAmbientLight")
QDEF(MP_QSTR_LsReadColor, (const byte*)"\xf5\x0b" "LsReadColor")
QDEF(MP_QSTR_LsReadGesture, (const byte*)"\xcf\x0d" "LsReadGesture")
QDEF(MP_QSTR_LsReadProximity, (const byte*)"\x9d\x0f" "LsReadProximity")
QDEF(MP_QSTR_LsReadRawColor, (const byte*)"\x11\x0e" "LsReadRawColor")
QDEF(MP_QSTR_LsSetSensitivity, (const byte*)"\xd5\x10" "LsSetSensitivity")
QDEF(MP_QSTR_LsWhiteBalanceEnable, (const byte*)"\x5a\x14" "LsWhiteBalanceEnable")
...
QDEF(MP_QSTR_Sensitivity1, (const byte*)"\xd9\x0c" "Sensitivity1")
QDEF(MP_QSTR_Sensitivity2, (const byte*)"\xda\x0c" "Sensitivity2")
QDEF(MP_QSTR_Sensitivity3, (const byte*)"\xdb\x0c" "Sensitivity3")
QDEF(MP_QSTR_SensitivityDefault, (const byte*)"\xa3\x12" "SensitivityDefault")
...
QDEF(MP_QSTR__brace_open__colon__hash_b_brace_close_, (const byte*)"\xf6\x27" "_brace_open__colon__hash_b_brace_close_")
QDEF(MP_QSTR__lt_dictcomp_gt_, (const byte*)"\x65\x10" "_lt_dictcomp_gt_")
QDEF(MP_QSTR__lt_genexpr_gt_, (const byte*)"\xdd\x0f" "_lt_genexpr_gt_")
QDEF(MP_QSTR__lt_lambda_gt_, (const byte*)"\xa9\x0e" "_lt_lambda_gt_")
QDEF(MP_QSTR__lt_listcomp_gt_, (const byte*)"\x7d\x10" "_lt_listcomp_gt_")
QDEF(MP_QSTR__lt_module_gt_, (const byte*)"\xf4\x0e" "_lt_module_gt_")
QDEF(MP_QSTR__lt_setcomp_gt_, (const byte*)"\xbd\x0f" "_lt_setcomp_gt_")
QDEF(MP_QSTR__lt_stdin_gt_, (const byte*)"\x2a\x0d" "_lt_stdin_gt_")
QDEF(MP_QSTR__lt_string_gt_, (const byte*)"\x3b\x0e" "_lt_string_gt_")
QDEF(MP_QSTR__percent__hash_o, (const byte*)"\x03\x10" "_percent__hash_o")
QDEF(MP_QSTR__percent__hash_x, (const byte*)"\x14\x10" "_percent__hash_x")
QDEF(MP_QSTR__star_, (const byte*)"\xb1\x06" "_star_")
...
QDEF(MP_QSTR_maximum_space_recursion_space_depth_space_exceeded, (const byte*)"\xd7\x32" "maximum_space_recursion_space_depth_space_exceeded")
